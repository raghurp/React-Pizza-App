      ...
      <Table className={classes.table} aria-label="customized table">
        <TableHead>
          ...
          <StyledTableCell> <b> # </b></StyledTableCell>
            <StyledTableCell align="right"> <b> Employee ID </b></StyledTableCell>
            <StyledTableCell> <b> Employee Name </b></StyledTableCell>
            <StyledTableCell align="right"> <b>Phone Number </b></StyledTableCell>
            <StyledTableCell align="right"> <b>Department </b></StyledTableCell>
            <StyledTableCell align="right"> <b>Age</b></StyledTableCell>
        ...
        <TableBody>
          {this.state.records.filter((val) => {
            ...
            val.emp_id.toLowerCase().includes(this.state.search.toLowerCase())  ){
              return val;
            }
          })
          ...
          .map((x) => (
            <TableRow key={x.id}>
               <StyledTableCell component="th" scope="row">{x.id}</StyledTableCell>
              <StyledTableCell align="right">{x.emp_id}</StyledTableCell>
              <StyledTableCell component="th" scope="row">{x.name}</StyledTableCell>
              <StyledTableCell align="right">{x.phone}</StyledTableCell>
              <StyledTableCell align="right">{x.department}</StyledTableCell>
              <StyledTableCell align="right">{x.age}</StyledTableCell>
